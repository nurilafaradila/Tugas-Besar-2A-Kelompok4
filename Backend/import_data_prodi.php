            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
						...
						<?php
							...
							if($_POST['submit']!=""){
									...
									for ($col = 0; $col < $highestColumnIndex; ++ $col) {
									 ...
									 mysql_query("INSERT INTO t_prodi VALUES ('".$val[0] . "','" . $val[1] . "')") or die(mysql_error());
									 }
									}
						...
						?>
                            ...
                            <form role="form" action="import_data_prodi.php" method="POST" enctype="multipart/form-data">
