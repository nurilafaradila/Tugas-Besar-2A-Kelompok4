        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <!-- /. ROW  -->
							...
							<form action="import_data_user.php">
							<button type="submit" class="btn btn-danger">Import</button>
                                ...
                                <table class="table table-striped">
									...
									$tampil=mysql_query("SELECT * FROM t_user ORDER BY id_user ASC");
									while ($r=mysql_fetch_array($tampil)){
                                        ...
                                        <th>$r[password]</th>
										<th>$r[level]</th>
										<th><a href='detail_data_user.php?id=$r[id_user]'>Detail</a></th>
										<th><a href='edit_data_user.php?id=$r[id_user]'>Edit</a></th>																				
										<th><a href='delete_data_user.php?id=$r[id_user]' onClick=\"return confirm('Apakah Anda yakin Menghapus $r[nama_user]?');\">Hapus</a></th>
										</tr>";
