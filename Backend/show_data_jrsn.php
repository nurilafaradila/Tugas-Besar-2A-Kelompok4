					...
					<li>
                        <a href="#" class="active-menu-top"><i class="fa fa-bicycle "></i>Jurusan <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                             ...
                             <li>
                                <a class="active-menu" href="show_data_jrsn.php"><i class="fa fa-code "></i>Data Jurusan</a>
                            </li>                                                       
                        </ul>
                    </li>
					<li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <!-- /. ROW  -->
							...
							<div class="row">
							<div class="col-md-1">
							<form action="import_data_jrsn.php">
							<button type="submit" class="btn btn-danger">Import</button>
							</form>
							</div>
							<div class="col-md-1">
							<form action="export_jurusan.php" >
							<button type="submit" class="btn btn-default">Export To Excel</button>
                                ...
                                <table class="table table-striped">
									...
									$tampil=mysql_query("SELECT * FROM t_jurusan ORDER BY id_jurusan ASC");
									while ($r=mysql_fetch_array($tampil)){
                                        ...
                                        <th>$r[jurusan]</th>
										<th>$r[id_prodi]</th>
										<th><a href='detail_data_jrsn.php?id=$r[id_jurusan]'>Detail</a></th>
										<th><a href='edit_data_jrsn.php?id=$r[id_jurusan]'>Edit</a></th>																				
										<th><a href='delete_data_jrsn.php?id=$r[id_jurusan]' onClick=\"return confirm('Apakah Anda yakin Menghapus $r[jurusan]?');\">Hapus</a></th>
										</tr>";
