					...
					<li>
                        <a href="#" class="active-menu-top"><i class="fa fa-bicycle "></i>Mata Kuliah <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                             ...
                             <li>
                                <a class="active-menu" href="show_data_matkul.php"><i class="fa fa-code "></i>Data Mata Kuliah</a>
                            </li>                                                       
                        </ul>
                    </li>
					<li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <!-- /. ROW  -->
							...
							<div class="row">
							<div class="col-md-1">
							<form action="import_data_matkul.php">
							<button type="submit" class="btn btn-danger">Import</button>
							</form>
							
							</div>
							<div class="col-md-1">
							<form action="export_matkul.php" >
							<button type="submit" class="btn btn-default">Export To Excel</button>
                                ...
                                <table class="table table-striped">
									...
									$tampil=mysql_query("SELECT * FROM t_mata_kuliah ORDER BY semester");
									while ($r=mysql_fetch_array($tampil)){
                                        ...
                                        <th>$r[sks]</th>
										<th>$r[semester]</th>
										<th><a href='detail_data_matkul.php?id=$r[kode_mata_kuliah]'>Detail</a></th>
										<th><a href='edit_data_matkul.php?id=$r[kode_mata_kuliah]'>Edit</a></th>																				
										<th><a href='delete_data_matkul.php?id=$r[kode_mata_kuliah]' onClick=\"return confirm('Apakah Anda yakin Menghapus $r[nama_mata_kuliah]?');\">Hapus</a></th>
										</tr>";
