					...
					<li>
                        <a href="#" class="active-menu-top"><i class="fa fa-bicycle "></i>Jurusan <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                             ...
                             <li>
                                <a class="active-menu" href="input_data_jrsn.php"><i class="fa fa-desktop "></i>Input Jurusan </a>
                            </li>
                             <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
						...
						$sql="INSERT INTO t_jurusan
						(id_jurusan,jurusan,id_prodi) 
						VALUES
						('$id_jurusan','$jurusan','$id_prodi')" or die(mysql_error());
						if(isset($cek)){
						echo"<div id='yellow'><b>Error: </b>" .implode($cek). " </div>";
						}else{
						if(mysql_query($sql)){
						echo"<div id='green'>Jurusan Berhasil Diinputkan </div>";
						}else{
						...
						?>
				           ...
				           <div class="panel-body">
                            <form role="form" action="input_data_jrsn.php" method="POST">
                                        <div class="form-group">
                                            <label>ID Jurusan</label>
                                            <input class="form-control" type="text" name="id_jurusan">
                                        </div>                                 
										<div class="form-group">
                                            <label>Jurusan</label>
