                        ...
                        <a href="#" class="active-menu-top"><i class="fa fa-bicycle "></i>Nilai <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
							<?php if($_SESSION['admin']!="" || $_SESSION['dosen']!="" ){?>
                             ...
                             <li>
                                <a class="active-menu" href="show_data_nilai.php"><i class="fa fa-code "></i>Data Nilai</a>
                            </li> 
								<?php } ?>
							<li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped">
									...
									if($_SESSION['level']=="mahasiswa"){
									    ...
									    $tampil=mysql_query("SELECT * FROM t_nilai where npm='$_SESSION[username]' ORDER BY id_nilai ASC");
									}
									else {
											$tampil=mysql_query("SELECT * FROM t_nilai ORDER BY id_nilai ASC");
									}
									...
									while ($r=mysql_fetch_array($tampil)){
										...
										<th><a href='delete_data_nilai.php?id=$r[id_nilai]' onClick=\"return confirm('Apakah Anda Yakin Menghapus $r[npm]?');\">Hapus</a></th>
										</tr>";								
									}
									?>
