        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="#" class="acvtive-menu-top"><i class="fa fa-bicycle "></i>Mata Kuliah <span class="fa arrow"></span></a>
        ...
        <div id="page-wrapper">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
						...
						sks='$sks',
						semester='$semester'
						WHERE kode_mata_kuliah='$_POST[kode_mata_kuliah]'" or die(mysql_error());
						if(isset($cek)){
						echo"<div id='yellow'><b>Error: </b>" .implode($cek). " </div>";
						}else{
						if(mysql_query($sql)){
						echo"<div id='green'>Mata Kuliah Berhasil Diedit </div>";
						}else{
						...
						$tampil=mysql_query("SELECT * FROM t_mata_kuliah where kode_mata_kuliah='$_GET[id]'");
						$data=mysql_fetch_array($tampil);
						?>
						
				             <div class="panel-body">
                            <form role="form" action="edit_data_matkul.php" method="POST">
                                        <div class="form-group">
                                            <label>Kode Mata Kuliah</label>
                                            <input class="form-control" type="text" name="kode_mata_kuliah" value="<?php echo"$data[kode_mata_kuliah]";?>">
                                        </div> 
										<div class="form-group">
                                            <?php
										...
										<div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="nama_mata_kuliah" value="<?php echo"$data[nama_mata_kuliah]";?>">
										</div>
										<div class="form-group">
                                            <label>SKS</label>
                                            <input class="form-control" type="text" name="sks" value="<?php echo"$data[sks]";?>">
										</div>
										<div class="form-group">
                                            ...
                                            <select class="form-control" name="semester">
                                                ...
                                                <option selected="selected" value="<?php echo "$data[semester]"; ?>">1</option>
                                                ...
                                                <option selected="selected" value="<?php echo "$data[semester]"; ?>">2</option>
												<option value="3">3</option>
												<option value="4">4</option>
												<option value="5">5</option>
												<option value="6">6</option>
                                                ...
                                                <option value="1">1</option>
                                                <option value="2">2</option>
												<option selected="selected" value="<?php echo "$data[semester]"; ?>">3</option>
												<option value="4">4</option>
												<option value="5">5</option>
												<option value="6">6</option>
												<option value="7">7</option>
                                                ...
                                                <option value="2">2</option>
												<option value="3">3</option>
												<option selected="selected" value="<?php echo "$data[semester]"; ?>">4</option>
												<option value="5">5</option>
												<option value="6">6</option>
												<option value="7">7</option>
												<option value="8">8</option>
												...
												<option value="3">3</option>
												<option value="4">4</option>
												<option selected="selected" value="<?php echo "$data[semester]"; ?>">5</option>
												<option value="6">6</option>
												<option value="7">7</option>
												<option value="8">8</option>
												<?php
												...
												<option value="4">4</option>
												<option value="5">5</option>
												<option selected="selected" value="<?php echo "$data[semester]"; ?>">6</option>
												<option value="7">7</option>
												<option value="8">8</option>
												<?php
												...
												<option value="5">5</option>
												<option value="6">6</option>
												<option selected="selected" value="<?php echo "$data[semester]"; ?>">7</option>
												<option value="8">8</option>
												<?php
													}
												else if($data['semester']=="7") {
												...
												<option value="6">6</option>
												<option value="7">7</option>
												<option selected="selected" value="<?php echo "$data[semester]"; ?>">8</option>
												<?php
													}
												}
