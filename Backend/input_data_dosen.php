                     ...
                     <li>
                        <a href="#" class="active-menu-top"><i class="fa fa-yelp "></i>Dosen <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                            <li>
                                <a class="active-menu" href="input_data_dosen.php"><i class="fa fa-coffee"></i>Input Data Mahasiswa</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
						...
						VALUES
						('$nip','$nama','$alamat')" or die(mysql_error());
						if(isset($cek)){
						echo"<div id='yellow'><b>Error: </b>" .implode($cek). " </div>";
						}else{
						if(mysql_query($sql)){
						echo"<div id='green'>Dosen Berhasil Diinputkan </div>";
						}else{
						...
						?>
                            ...
                            <form role="form" action="input_data_dosen.php" method="POST">
										...
										<div class="form-group">
                                            <label>Alamat</label>
                                            <textarea class="form-control" rows="3" name="alamat_dosen"></textarea>
                                        </div>                                
