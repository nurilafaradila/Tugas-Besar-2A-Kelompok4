        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="#" class="active-menu-top"><i class="fa fa-bicycle "></i>Jurusan <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
        ...
        <div id="page-wrapper">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
						...
						if($jurusan ==''){
						$cek[] ="Jurusan Harus diisi,";
						}
						
												
						$sql="UPDATE t_prodi SET
						...
						if(mysql_query($sql)){
						echo"<div id='green'>Jurusan Berhasil Diedit </div>";
						}else{
						...
						$tampil=mysql_query("SELECT * FROM t_jurusan where id_jurusan='$_GET[id]'");
						$data=mysql_fetch_array($tampil);
						?>
						
				             <div class="panel-body">
                            <form role="form" action="edit_data_prodi.php" method="POST">
										...
										<div class="form-group">
                                            <label>Jurusan</label>
                                            <input class="form-control" type="text" name="jurusan" value="<?php echo"$data[jurusan]";?>">
										</div>
										<div class="form-group">
                                            <label>ID Prodi</label>
                                            <input class="form-control" type="text" name="id_prodi" value="<?php echo"$data[id_prodi]";?>">
										</div>
							</div>
