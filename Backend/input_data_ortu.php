                    ...
                    <li>
                        <a href="#" class="active-menu-top"><i class="fa fa-desktop "></i>Mahasiswa <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                            ...
                            <li>
                                <a class="active-menu" href="input_data_ortu.php"><i class="fa fa-edit"></i>Input Data Orangtua</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
						...
						$sql="INSERT INTO t_orangtua_mhs
						(id_orangtua,nama_orangtua,alamat_orangtua,npm,no_hp) 
						VALUES
						('$id_orangtua','$nama','$alamat','$npm','$nohp')" or die(mysql_error());
						
						if(isset($cek)){
						echo"<div id='yellow'><b>Error: </b>" .implode($cek). " </div>";
						}else{
						if(mysql_query($sql)){
						echo"<div id='green'>Orangtua Mahasiswa Berhasil Diinputkan </div>";
						}else{
						...
						?>
                            ...
                            <form role="form" action="input_data_ortu.php" method="POST">
                                        <div class="form-group">
                                            <label>ID Orangtua</label>
                                            <input class="form-control" type="text" name="id_orangtua">
                                        </div>  
                                        ...
                                        <div class="form-group">
                                            <label>Alamat</label>
                                            <textarea class="form-control" rows="3" name="alamat_orangtua"></textarea>
                                        </div>
										...
										<?php
                                            echo "<tr><label>NPM </label>  <td>
											  <select class='form-control' name='npm'>
												...
												$tampil=mysql_query("SELECT * FROM t_mahasiswa ORDER BY nama_mhs");
