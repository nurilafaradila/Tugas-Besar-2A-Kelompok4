                ...
                <ul class="nav" id="main-menu">
                    ...
                    <a href="#" class="active-menu-top"><i class="fa fa-yelp "></i>User <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                            <li>
                                <a class="active-menu" href="input_data_user.php"><i class="fa fa-coffee"></i>Input Data User</a>
                            </li>
                            <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
						...
						VALUES
						('$nama','$username','$password3','$level')" or die(mysql_error());
						if(isset($cek)){
						...
						?>
                            ...
                            <form role="form" action="input_data_user.php" method="POST">
