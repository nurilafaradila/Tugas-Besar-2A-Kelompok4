        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu-top" href="#"><i class="fa fa-desktop "></i>Mahasiswa <span class="fa arrow"></span></a>
        ...
        <div id="page-wrapper">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
						...
						$alamat=$_POST['alamat_orangtua'];
						$npm=$_POST['npm'];
						$nohp=$_POST['no_hp'];
						
						if($id_orangtua ==''){
						$cek[] ="id_orangtua Harus diisi,";
						}
						if($nama ==''){
						$cek[] ="Nama Orangtua Harus diisi,";
						}
						if($alamat ==''){
						...
						if($nohp ==''){
						$cek[] ="No Handphone Harus diisi,";
						}
						
						$sql="UPDATE t_orangtua_mhs set
						id_orangtua='$id_orangtua',
						nama_orangtua='$nama',
						alamat_orangtua='$alamat',
						npm='$npm',
						no_hp='$nohp'						
						WHERE id_orangtua='$_POST[id_orangtua]'" or die(mysql_error());;
						if(isset($cek)){
						echo"<div id='yellow'><b>Error: </b>" .implode($cek). " </div>";
						}else{
						if(mysql_query($sql)){
						echo"<div id='green'>Orangtua Mahasiswa Berhasil diedit </div>";
						}else{
						...
						?>
                            ...
                            <form role="form" action="edit_data_ortu.php" method="POST">
                                        <div class="form-group">
                                            <label>ID Orangtua</label>
                                            <input class="form-control" type="text" name="id_orangtua" value="<?php echo"$data[id_orangtua]";?>">
                                        </div>          
										
										<div class="form-group">
                                            <label>Nama Orangtua</label>
                                            <input class="form-control" type="text" name="nama_orangtua" value="<?php echo"$data[nama_orangtua]";?>">
										</div>
										
                                        <div class="form-group">
                                            <label>Alamat</label>
                                            <textarea class="form-control" rows="3" name="alamat_orangtua"><?php echo"$data[alamat_orangtua]";?></textarea>
                                        </div>
