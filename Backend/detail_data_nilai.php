            ...
            <div id="page-inner">
                ...
                <!-- /. ROW  -->
							...
							<?php
									...
									$id = $_GET['id'];
									$tampil=mysql_query("SELECT * FROM t_nilai WHERE id_nilai='$id'");
                            ...
                            <div class="table-responsive">
							 ...
							 <table class="table table-striped">
									...
									$tampil=mysql_query("SELECT a.kode_mata_kuliah,a.nilai,b.nama_mata_kuliah FROM t_detail_nilai a LEFT JOIN t_mata_kuliah b on a.kode_mata_kuliah = b.kode_mata_kuliah where a.id_nilai='$data[id_nilai]'");
