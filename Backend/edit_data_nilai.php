        ...
        <div id="page-wrapper">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
						...
						if($nilai ==''){
						$cek[] ="Nilai Harus diisi,";
						}
						
												
						$sql="UPADATE t_nilai SET
						id_nilai='$id_nilai',
						npm='$npm',
						kode_mata_kuliah='$kode_matkul',
						nilai='$nilai'
						WHERE id_nilai='$_POST[id_nilai]'" or die(mysql_error());
						if(isset($cek)){
						echo"<div id='yellow'><b>Error: </b>" .implode($cek). " </div>";
						}else{
						if(mysql_query($sql)){
						echo"<div id='green'>Nilai Berhasil Diedit </div>";
						}else{
						...
						$tampil=mysql_query("SELECT * FROM t_nilai where id_nilai='$_GET[id]'");
						$data=mysql_fetch_array($tampil);
						?>
						
				            <div class="panel-body">
                            <form role="form" action="edit_data_nilai.php" method="POST">
                                        <div class="form-group">
                                            <label>ID Nilai</label>
                                            <input class="form-control" type="text" name="id_nilai" value="<?php echo"$data[id_nilai]";?>">
                                        </div>                                 
										<div class="form-group">
                                            <label>NPM</label>
