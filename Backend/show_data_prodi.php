					...
					<li>
                        <a href="#" class="active-menu-top"><i class="fa fa-bicycle "></i>Prodi<span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                             ...
                             <li>
                                <a class="active-menu" href="show_data_prodi.php"><i class="fa fa-code "></i>Data Prodi</a>
                            </li>                                                       
                        </ul>
                    </li>
					<li>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <!-- /. ROW  -->
							...
							<div class="row">
							<div class="col-md-1">
							<form action="import_data_prodi.php">
							<button type="submit" class="btn btn-danger">Import</button>
							</form>
							</div>
							<div class="col-md-1">
							<form action="export_prodi.php" >
							<button type="submit" class="btn btn-default">Export To Excel</button>
                               ...
                               <table class="table table-striped">
									...
									$tampil=mysql_query("SELECT * FROM t_prodi ORDER BY id_prodi ASC");
									while ($r=mysql_fetch_array($tampil)){
										echo "<tr>
										
										<th>$r[id_prodi]</th>
                                        <th>$r[prodi]</th>
										<th><a href='detail_data_prodi.php?id=$r[id_prodi]'>Detail</a></th>
										<th><a href='edit_data_prodi.php?id=$r[id_prodi]'>Edit</a></th>																				
										<th><a href='delete_data_prodi.php?id=$r[id_prodi]' onClick=\"return confirm('Apakah Anda yakin Menghapus $r[prodi]?');\">Hapus</a></th>
										</tr>";
