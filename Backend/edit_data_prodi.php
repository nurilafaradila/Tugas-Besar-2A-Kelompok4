        ...
        <div id="page-wrapper">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
						...
						id_prodi='$id_prodi',
						prodi='$prodi'
						WHERE id_prodi='$_POST[id_prodi]'" or die(mysql_error());
						if(isset($cek)){
						echo"<div id='yellow'><b>Error: </b>" .implode($cek). " </div>";
						}else{
						if(mysql_query($sql)){
						echo"<div id='green'>Prodi Berhasil Diedit </div>";
						}else{
						...
						$tampil=mysql_query("SELECT * FROM t_prodi where id_prodi='$_GET[id]'");
						...
						?>
                            ...
                            <form role="form" action="edit_data_prodi.php" method="POST">
										...
										<div class="form-group">
                                            <label>Prodi</label>
                                            <input class="form-control" type="text" name="prodi" value="<?php echo"$data[prodi]";?>">
										</div>
										</div>
