            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
						...
						<?php
							...
							if($_POST['submit']!=""){
									...
									for ($col = 0; $col < $highestColumnIndex; ++ $col) {
									 ...
									 mysql_query("INSERT INTO t_orangtua_mhs VALUES ('".$val[0] . "','" . $val[1] . "','" . $val[2]. "','" .$val[3]. "','" . $val[4]. "')") or die(mysql_error());
									 }
									}
						...
						?>
                            ...
                            <form role="form" action="import_data_ortu.php" method="POST" enctype="multipart/form-data">
