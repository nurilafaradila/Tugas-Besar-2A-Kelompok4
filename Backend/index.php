...
<body>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<?php } ?>
					<?php  if($_SESSION['level']=="admin" || $_SESSION['level']=="dosen" || $_SESSION['level']=="mahasiswa"){  ?>
					<li>
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h1 class="page-subhead-line">Selamat datang  </h1>
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            ...
                                            <div class="col-md-10 col-md-offset-1">
                                                ...
                                                <h4></i>Sistem Informasi Kampus merupakan sarana pendukung kinerja untuk pegawai, dosen dan mahasiswa di lingkungan Kampus Politeknik Pos Indonesia. Terdapat menu-menu yang dapat Anda akses yang sudah dsesuaikan dengan jabatan dan posisi Anda dalam struktur Kampus Politeknik Pos Indonesia</i></h4>
                                        ...
                                        <div class="item">
                                            <div class="col-md-10 col-md-offset-1">
                                                ...
                                                <h4></i>Untuk Panduan dan bantuan dalam mempergunakan sistem informasi kampus ini , silakan hubungi telepon ke nomor internal 179 atau eksternal 022-2009570 atau email ke bantuan@poltekpos.ac.id</i></h4>
    ...
    <!-- /. WRAPPER  -->
	<div id="footer-sec">
        &copy; 2016 POLITEKNIK POS INDONESIA | Design By : <a href="#" target="_blank">Muhammad Ramadhan & Putri Suciani</a>
    </div>
    <!-- /. FOOTER  -->
