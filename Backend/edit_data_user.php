                ...
                <ul class="nav" id="main-menu">
                    ...
                    <a href="#" class="active-menu-top"><i class="fa fa-yelp "></i>User <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level collapse in">
                            ...
                            <li>
                                <a class="active-menu" href="show_data_user.php"><i class="fa fa-flash "></i>Data User</a>
                            </li>                                                                          
                        </ul>
                    </li>
                    <li>
        ...
        <div id="page-wrapper">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
               <div class="panel panel-info">
						...
						if($nama ==''){
						$cek[] ="Nama User Harus diisi,";
						}
						if($username ==''){
						$cek[] ="Username Harus diisi,";
						}
						if($password ==''){
						...
						password='$password3',
						level='$level'
						WHERE id_user='$_POST[id_user]'" or die(mysql_error());
						if(isset($cek)){
						echo"<div id='yellow'><b>Error: </b>" .implode($cek). " </div>";
						}else{
						if(mysql_query($sql)){
						echo"<div id='green'>User Berhasil Diinputkan </div>";
						}else{
						...
						$tampil=mysql_query("SELECT * FROM t_user where id_user='$_GET[id]'");
						$data=mysql_fetch_array($tampil);
						?>
						
				            <div class="panel-body">
                            <form role="form" action="edit_data_user.php" method="POST">
                                        <div class="form-group">
                                            <label for="disabledInput">ID User</label>
                                            <input class="form-control" id="disabledInput" type="text" name="id_user" placeholder="<?php echo"$data[id_user]";?>" disabled="">
                                        </div>                                 
										<div class="form-group">
                                            <label>Nama User</label>
                                            <input class="form-control" type="text" name="nama_user" value="<?php echo"$data[nama_user]";?>">
										</div>
										<div class="form-group">
										...
										<div class="form-group">
                                            ...
                                            <input class="form-control" type="password" name="password2" value="<?php echo"$data[password]";?>">
										</div>
										<div class="form-group">
                                            <label>Level</label>
                                            <select class="form-control" name="level">
                                                ...
                                                <option selected="selected" value="<?php echo "$data[level]"; ?>">Admin</option>
                                                ...
                                                <option selected="selected" value="<?php echo "$data[level]"; ?>">Dosen</option>
												<option value="mahasiswa">Mahasiswa</option>
												<?php
													}
                                                ...
                                                <option value="admin">Admin</option>
                                                <option value="dosen">Dosen</option>
												<option selected="selected" value="<?php echo "$data[level]"; ?>">Mahasiswa</option>
												<?php
													}
												}
												else if($data['level']=="") {
