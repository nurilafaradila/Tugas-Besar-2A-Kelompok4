        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <!-- /. ROW  -->
							...
							<div class="row">
							<div class="col-md-1">
							<form action="import_data_dosen.php">
							<button type="submit" class="btn btn-danger">Import</button>
							</form>
							</div>
							<div class="col-md-1">
							<form action="export_dosen.php" >
							...
							<?php } ?>
                                <table class="table table-striped">
									...
									if($_SESSION['level']=="dosen"){
									    ...
									    $tampil=mysql_query("SELECT * FROM t_dosen where nip='$_SESSION[username]' ORDER BY nama_dosen ASC");
									}else {
											$tampil=mysql_query("SELECT * FROM t_dosen ORDER BY nip ASC");
									}
									...
									while ($r=mysql_fetch_array($tampil)){
										...
										<th>$r[nip]</th>
                                        <th>$r[nama_dosen]</th>
                                        <th>$r[alamat_dosen]</th>
										<th><a href='detail_data_dosen.php?id=$r[nip]'>Detail</a></th>
										<th><a href='edit_data_dosen.php?id=$r[nip]'>Edit</a></th>"
										?>	
										
										<?php if($_SESSION['level']=="admin"){  ?>	
										<?php
										echo
										"<th><a href='delete_data_dosen.php?id=$r[nip]' onClick=\"return confirm('Apakah Anda yakin Menghapus $r[nama_dosen]?');\">Hapus</a></th>										
										</tr>";		
									}
									?>
									<?php } ?>
